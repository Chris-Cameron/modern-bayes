...
```{r , echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:trace-theta}Traceplot of theta"}
plot(1:n.iter, res[,1], pch = 16, cex = .35,
     xlab = "Iteration", ylab = expression(theta),
     main = expression(paste("Traceplot of ", theta)))
```
...
```{r , echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:trace-z}Traceplot of $z_3, z_8, z_9, z_{10}, z_{12}.$"}
missing.index <- c(3,8,9,10,12)
par(mfrow=c(2,3))
for (ind in missing.index){
  x.lab <- bquote(z[.(ind)])
...
```{r , echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:run-theta}Running average plot of theta"}
plot(1:n.iter, run.avg[,1], type = "l",
     xlab = "Iteration", ylab = expression(theta),
     main = expression(paste("Running Average Plot of ", theta)))
```

```{r , echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:run-z}Running average plots of $z_3, z_8, z_9, z_{10}, z_{12}.$"}
par(mfrow=c(2,3))
missing.index <- c(3,8,9,10,12)
for (ind in missing.index){
  x.lab <- bquote(z[.(ind)])
...
When the value of b is changed to 100, the posterior mean in part c changes
significantly, decreasing to below 0.6 for $\theta$, and increasing to about
18 for $z_9$. The opposite occurs when the value of a is changed to 100, with
the value of $\theta$ increasing to above 7, and the value of $z_9$ dropping to around
2.3.
...
```{r echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:trace-theta}Traceplot of theta with b=100"}
plot(1:n.iter, res[,1], pch = 16, cex = .35,
     xlab = "Iteration", ylab = expression(theta),
     main = expression(paste("Traceplot of ", theta)))
```
...
```{r echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:trace-z}Traceplot of $z_9$ with b=100"}
plot(1:n.iter, res[,1], pch = 16, cex = .35,
...
```{r echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:run-theta}Running average plot of theta with b=100"}
plot(1:n.iter, run.avg[,1], type = "l",
     xlab = "Iteration", ylab = expression(theta),
     main = expression(paste("Running Average Plot of ", theta)))
```

```{r fig.width=7,fig.height=6,fig.cap="\\label{fig:run-z}Running average plot of $z_9$ with b=100"}
plot(1:n.iter, run.avg[,1], type = "l",
     xlab = "Iteration", ylab = expression(z[9]),
     main = expression(paste("Traceplot of ", z[9])))
```

```{r echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:density-theta}Estimated posterior density of theta with b=100"}
# density plots
plot(density(res[,1]), xlab = expression(theta), 
     main = expression(paste("Density of ", theta)))
abline(v = mean(res[,1]), col = "red")
...
```{r echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:density-z}Estimated posterior density of $z_9$ with b=100."}
plot(density(res[,4]), xlab = expression(z[9]),
     main = expression(paste("Density of ", z[9])))
abline(v = mean(res[,4]), col = "red")
```
...
```{r echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:trace-theta}Traceplot of theta with a=100"}
plot(1:n.iter, res[,1], pch = 16, cex = .35,
     xlab = "Iteration", ylab = expression(theta),
     main = expression(paste("Traceplot of ", theta)))
```
...
```{r echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:trace-z}Traceplot of $z_9$ with a=100"}
plot(1:n.iter, res[,1], pch = 16, cex = .35,
     xlab = "Iteration", ylab = expression(z[9]),
     main = expression(paste("Traceplot of ", z[9])))
```
...
```{r echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:run-theta}Running average plot of theta with a=100"}
plot(1:n.iter, run.avg[,1], type = "l",
     xlab = "Iteration", ylab = expression(theta),
     main = expression(paste("Running Average Plot of ", theta)))
```

```{r fig.width=7,fig.height=6,fig.cap="\\label{fig:run-z}Running average plot of $z_9$ with a=100"}
plot(1:n.iter, run.avg[,1], type = "l",
     xlab = "Iteration", ylab = expression(z[9]),
     main = expression(paste("Traceplot of ", z[9])))
```

```{r echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:density-theta}Estimated posterior density of theta with a=100"}
# density plots
plot(density(res[,1]), xlab = expression(theta), 
     main = expression(paste("Density of ", theta)))
abline(v = mean(res[,1]), col = "red")
...
```{r echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:density-z}Estimated posterior density of $z_9$ with a=100."}
plot(density(res[,4]), xlab = expression(z[9]),
     main = expression(paste("Density of ", z[9])))
abline(v = mean(res[,4]), col = "red")
```
